...
void main() {
  ...
  test("perform delta calculation on values", () async {
    ...
    testMeter.addValue(MeterValue(DateTime(2022, 1, 1), 14));

    service.meterType.value = MeterType.rh;
  ...
  test('perform meter value price calc in one rate', () async {
    testMeter.addValue(MeterValue(DateTime(2022, 1, 1), 1));
    ...
    service.meterType.value = MeterType.gas;
    Get.put<Meter>(testMeter, tag: 'meterEdit');
